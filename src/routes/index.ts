...
import portfolioManagementRoutes from './portfolio-management.routes';
...
router.use('/portfolios', portfolioManagementRoutes);
...
router.use('/billionaires', billionaireRoutes);

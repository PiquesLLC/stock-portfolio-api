...
export async function listWatchlistsHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist list error:', error instanceof Error ? error.message : String(error));
...
export async function getWatchlistHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist detail error:', error instanceof Error ? error.message : String(error));
...
export async function createWatchlistHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist create error:', error instanceof Error ? error.message : String(error));
...
export async function updateWatchlistHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist update error:', error instanceof Error ? error.message : String(error));
...
export async function deleteWatchlistHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist delete error:', error instanceof Error ? error.message : String(error));
...
export async function addWatchlistHoldingHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist holding add error:', error instanceof Error ? error.message : String(error));
...
export async function updateWatchlistHoldingHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist holding update error:', error instanceof Error ? error.message : String(error));
...
export async function removeWatchlistHoldingHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist holding delete error:', error instanceof Error ? error.message : String(error));
...
export async function getWatchlistChartHandler(req: AuthRequest, res: Response): Promise<void> {
  try {
    ...
    console.error('Watchlist chart error:', error instanceof Error ? error.message : String(error));
    res.status(500).json({
